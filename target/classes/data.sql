INSERT INTO `bd_nuevocursos`.`cursos` (`codCurso`, `nombre`, `duracion`, `precio`) VALUES ('1', 'Matematicas', '50', '100');
INSERT INTO `bd_nuevocursos`.`cursos` (`codCurso`, `nombre`, `duracion`, `precio`) VALUES ('2', 'Lenguaje', '40', '200');
